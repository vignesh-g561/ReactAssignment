    ...
    render : function () {
      ...
      return(
        React.createElement("div", null, 
          ...
          React.createElement(MovieComponent, {update: this.addMovie}), 
          React.createElement("div", {className: "col-12 panel"}, 
            React.createElement(Results, {memory: this.state.data, imdbMovie: this.addimdbData}), 
            React.createElement(MoviesFromDb, {mydb: this.state.dbObj, imdbMovie: this.addimdbData}), 
              ...
              React.createElement("div", {className: "modal-dialog", role: "document"}, 
                React.createElement("div", {className: "modal-content"}, 
                  React.createElement("div", {className: "modal-header"}, 
                    ...
                    React.createElement("h4", {className: "modal-title", id: "myModalLabel"}, "Movie: ", movie.Title)
                  ), 
                  React.createElement("div", {className: "modal-body"}, 

                  React.createElement("div", {className: "row"}, 
                    React.createElement("img", {src: movie.Poster, className: "img-thumbnail"}), 
                    React.createElement("div", {className: "col-md-6"}, 
                      React.createElement("h3", null, movie.Title), 
                      React.createElement("p", null, "Year:", movie.Year), 
                      React.createElement("p", null, "Actors:", movie.Actors), 
                      React.createElement("p", null, "Director:", movie.Director), 
                      React.createElement("p", null, movie.Plot), 
                      React.createElement("p", null, 
                      React.createElement("span", {className: "glyphicon glyphicon-calendar"}), 
                        movie.Released, 
                      React.createElement("span", null, " | "), 
                      React.createElement("span", null, 
                        React.createElement("b", null, "Rating: ", React.createElement(RatingComponent, {rdata: movie.imdbRating})
                        )
                      ), 
                      React.createElement("span", null, " | "), 
                      React.createElement("span", null, 
                        React.createElement("b", null, "Awards:"), 
                        movie.Awards
                      )
                      ), 
                      React.createElement("p", null, React.createElement("button", {"data-dismiss": "modal", onClick: this.handleSaveMovie}, "ADD TO DATABASE "))
                    )
                  )
                  )
                )
...
},{"./MovieComponent":203,"./MoviesFromDb":204,"./Navbar":205,"./RatingComponent":206,"./Results":207,"react":199}],201:[function(require,module,exports){
var React = require('react');
var Navbar = require('./Navbar');
...
module.exports = Home;
},{"./Navbar":205,"react":199}],202:[function(require,module,exports){
var React = require('react');
...
var React = require('react');
var MovieComponent = React.createClass({displayName: "MovieComponent",
  getInitialState : function() {
        ...
        React.createElement("table", {className: "table"}, 
          React.createElement("tr", null, 
            React.createElement("td", null, 
              React.createElement("input", {type: "text", className: "form-control", id: "title", placeholder: "Title", 
              onChange: this.handleTitleChange})
            ), 
            React.createElement("td", null, 
              React.createElement("button", {onClick: this.submitHandler, className: "btn btn-primary submit-btn"}, "Search")
            )
          )
        )
...
var React = require('react');
var MoviesFromDb = React.createClass({displayName: "MoviesFromDb",
  ...
  render:function() {
    ...
    var movieRender = data.map(function (movie,ind) {
      return(
        React.createElement("div", {key: ind}, 
          React.createElement("div", {className: "row"}, 
            React.createElement("img", {src: movie.Poster, className: "img-thumbnail"}), 
            React.createElement("div", {className: "col-md-6"}, 
              React.createElement("h3", null, movie.Title), 
            ...
            React.createElement("div", {className: "col-md-2"}, 
              React.createElement("button", {className: "btn btn-primary submit-btn", onClick: this.handleDeleteMovie}, "Remove")
            )
          )
        )
      );
    ...
    return(
      React.createElement("span", null, movieRender)
    );
  }
});
              ...
              React.createElement("nav", {className: "navbar navbar-default"}, 
                React.createElement("div", {className: "container-fluid"}, 
                  ...
                  React.createElement("ul", {className: "nav navbar-nav"}, 
                    ...
                    React.createElement("li", null, React.createElement(Link, {to: "/AddMovies"}, "Add Movies"))
                  )
                )
              )
            )
...
var React = require('react');
var RatingComponent = React.createClass({displayName: "RatingComponent",
render: function(){
  var radata = Math.floor(this.props.rdata);
  var a=[];
  for(var i=0;i<radata;i++)
  {
    a.push(React.createElement("span", {className: "glyphicon glyphicon-star"}))
  }
  return(
      ...
      return(
        React.createElement("div", {key: ind}, 
          React.createElement("div", {className: "row"}, 
            ...
            React.createElement("div", {className: "col-md-2"}, 
              React.createElement("button", {className: "btn btn-primary submit-btn", "data-toggle": "modal", "data-target": "#myModal", onClick: (event) => ref(movie), style: {"margin-left":"30px"}}, "View")
            )
          )
        )
      );
...
},{"./routes.js":209,"react":199,"react-dom":10,"react-router":35}],209:[function(require,module,exports){
var React = require('react');
var Router = require('react-router');
...
React.createElement(Route, null, 
  ...
  React.createElement(Route, {handler: Content, name: "AddMovies", path: "/AddMovies"}), 
  React.createElement(Route, {handler: HomePage, name: "HomePage", path: "/Home"})
)
);
},{"./Components/Content":200,"./Components/Home":201,"./Components/Master":202,"./Components/MoviesFromDb":204,"react":199,"react-router":35}]},{},[208]);
